...
categorized=[]
user_requirement=input("enter a category to search:")
for prod in data:
  if prod["category"]==user_requirement:
    categorized.append(prod)
if categorized:
  print(f"the categroized product is,{categorized}")
